...
//go:generate go run github.com/0x51-dev/upeg/cmd/abnf --in=abnf/testdata/ipv6.abnf --out=abnf/custom_test.go --package=abnf_test --custom=IPv6address --dependencies=github.com/0x51-dev/upeg/abnf/core,HEXDIG,DIGIT
